...
console.log(language.charAt('0').concat(language.charAt('4')).concat(language.charAt('7')))
...
console.log(notTitleCase.split(' ').map(e => e.charAt(0).toUpperCase() + e.substring(1)).join(' '))
